...
for each trial, randomly choose a trial type (match/mismatch), one color word and one color for the font: use Python's random or expyriment.design.randomize modules
...
def run_experiment():
    ...
    # Create all trials (32 total)
    all_trials = create_trials(32)

    # Divide into 2 blocks of 10 trials each
    blocks = [all_trials[:16], all_trials[16:]]
